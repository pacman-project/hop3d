...
namespace putslam {
    ...
    class KabschEst : public TransformEst {
        public:
            ...
            hop3d::Mat34& computeTransformation(const Eigen::MatrixXd& setA, const Eigen::MatrixXd& setB);

            /// compute transformation using two set of keypoints
            static hop3d::Mat34 computeTrans(const Eigen::MatrixXd& setA, const Eigen::MatrixXd& setB);
