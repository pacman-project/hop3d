...
public:
    ...
    virtual void update(std::vector<std::vector<std::vector<hop3d::PointCloudRGBA>>>& clouds, bool inference) = 0;
...
public:
    ...
    void notify3Dmodels();
    void notify(std::vector<std::vector<std::vector<hop3d::PointCloudRGBA>>>& clouds, bool inference);
    /// update object from filters
