...
private:
    ...
    /// assign parts to clusters according to given cetroid
    void fit2clusters(const std::vector<int>& centroids, const ViewIndependentPart::Seq& dictionary, std::vector<ViewIndependentPart::Seq>& clusters, std::vector<std::vector<Mat34>>& offsets);
    ...
    /// compute centroids for give clusters
    void computeCentroids(const std::vector<ViewIndependentPart::Seq>& clusters, std::vector<int>& centroids, const ViewIndependentPart::Seq& dictionary, std::vector<std::vector<Mat34>>& offsets);
