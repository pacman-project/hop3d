/** @file datasetoris.h
 *
 * implementation - dataset Pacman
 *
 */

#ifndef DATASET_PACMAN_H_INCLUDED
#define DATASET_PACMAN_H_INCLUDED
...
class PacmanDataset: public Dataset {
public:
    /// Pointer
    typedef std::unique_ptr<PacmanDataset> Ptr;

    /// Construction
    PacmanDataset(void);

    /// Construction
    PacmanDataset(std::string config, std::string sensorConfig);
...
#endif // DATASET_PACMAN_H_INCLUDED
